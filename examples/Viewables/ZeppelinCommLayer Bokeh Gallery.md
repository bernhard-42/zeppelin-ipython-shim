...
>    `https://raw.githubusercontent.com/bernhard-42/zeppelin-ipython-shim/master/examples/ZeppelinCommLayer%20Bokeh%20Gallery.json`

# examples/ZeppelinCommLayer Bokeh Gallery.json
...
```python
%pyspark
#!zeppelin2md:bokeh-gallery-1.png
...
![bokeh-gallery-1.png](bokeh-gallery-1.png)
...
```python
%pyspark
#!zeppelin2md:bokeh-gallery-2.png
...
![bokeh-gallery-2.png](bokeh-gallery-2.png)
...
```python
%pyspark
#!zeppelin2md:bokeh-gallery-3.png
...
![bokeh-gallery-3.png](bokeh-gallery-3.png)
...
```python
%pyspark
#!zeppelin2md:bokeh-gallery-4.png
...
![bokeh-gallery-4.png](bokeh-gallery-4.png)
...
```python
%pyspark
#!zeppelin2md:bokeh-gallery-5.png
...
![bokeh-gallery-5.png](bokeh-gallery-5.png)
...
```python
%pyspark
#!zeppelin2md:bokeh-gallery-6.png
...
![bokeh-gallery-6.png](bokeh-gallery-6.png)
...
```python
%pyspark
#!zeppelin2md:bokeh-gallery-7.png
...
![bokeh-gallery-7.png](bokeh-gallery-7.png)
